...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, LogEvent> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "ai-analysis-group");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        
        JsonDeserializer<LogEvent> jsonDeserializer = new JsonDeserializer<>(LogEvent.class);
        jsonDeserializer.addTrustedPackages("com.loganalyzer.common.dto");
